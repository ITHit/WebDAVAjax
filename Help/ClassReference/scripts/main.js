$(function () {
    ...
    (function() {
        ...
        treeCheckAutoOpen($('.navigation > ul'));
    })();
    ...
    if ($currentItem.length) {
        ...
        setTimeout(function() {
            $('.navigation > .list').scrollTop($currentItem.find('> .title').offset().top - $('.navigation > .list').offset().top - 10);
        });
    }
    ...
    var _onResize = function () {
        ...
        $el.height(height).find('> .list').height(height - $el.find('> .applicationName').outerHeight(true) - $el.find('> .search').outerHeight(true));
        ...
        (function() {
            ...
            $('.class-tree td div').css('width', $('.class-tree').width() - width - 25);
        })();
    };
